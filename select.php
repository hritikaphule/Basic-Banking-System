...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js"
        ...
        crossorigin="anonymous"></script>
    <style>body {
    background-image: url("C:\xampp\htdocs\Basic-Banking-System-main\img\bank.jpeg");
...
<body>
    ...
    <div id="title">
        <nav id="navbar" class="navbar navbar-expand-lg navbar-dark ">
            <a id="navbar-brand" href="index.php">Unicorn's<span>  Bank</span></a>
...
<footer id="footer">
  ...
  <p>© Copyright 2022 Unicorn's Bank</p>
</footer>
